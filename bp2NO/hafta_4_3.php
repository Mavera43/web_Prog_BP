<?php
  $diller = Array("php"=>"Php Dersleri", "C#"=>"Csharp Dersleri",
  "Pyton"=>"Pyton Dersleri","Mobil"=>"Mobil Programlama Dersleri");
   echo "<pre>";
  // print_r($diller);
   echo "</pre>";
?>
...
<div class="container">
  ...
  <div class="checkbox">
    <input type="checkbox" name="ogrenci" value="ogrenci" >ogrenci
  </div>
...
<?php
    foreach ($diller as $key => $value) {
       echo' <div class="checkbox">
        <input type="checkbox" name="dil[]" value='.$key.' >'.$value.'
      </div>';
    }
    ?>
